...
import { Calendar, Trophy, Users, Clock, Target, ChevronRight, ArrowUpRight, Bell, UserCheck, ShieldAlert, Medal, Gamepad } from 'lucide-react';
import UpcomingMatches from '@/components/tournaments/UpcomingMatches';
    ...
    <div className="container py-6 md:py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <div className="flex gap-3">
          {/* Remove balance display if not present on userProfile */}
          {/* <Button asChild variant="outline" className="border-gray-700">
            <Link href="/wallet">
              <Wallet className="mr-2 h-4 w-4" />
              Balance: {formatCurrency(userProfile.balance, userProfile.currency)}
            </Link>
          </Button> */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-dark-card border-gray-800 overflow-hidden">
            <div className="p-6 pb-2">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">Tournaments</h2>                <Button asChild variant="ghost" size="sm" className="text-sm text-gray-400">
                  <Link to="/tournaments">
                    View All
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-3 mt-2 text-sm">
                              <div className="flex items-center text-gray-400">
                                ...
                                {/* Fix: Only call new Date if tournament.startDate is defined */}
                                {tournament.startDate ? new Date(tournament.startDate).toLocaleDateString() : "N/A"}
                              </div>
                              <div className="flex items-center text-gray-400">
                                <Clock className="mr-1 h-3.5 w-3.5" />
                                {/* Fix: Only call getRemainingTime if tournament.startDate is defined */}
                                {tournament.startDate ? getRemainingTime(typeof tournament.startDate === 'string' ? new Date(tournament.startDate) : tournament.startDate) : "N/A"}
                              </div>
                              <div className="flex items-center text-gray-400">
                            ...
                            <div className="flex items-center justify-between mt-3">
                              <div>
                                ...
                                <div className="font-medium">
                                  {formatCurrency(tournament.entryFee, userProfile.currency)}
                                </div>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="font-medium text-green-400">
                                  {formatCurrency(tournament.prizePool, userProfile.currency)}
                                </div>
                              </div>
          ...
          <Card className="bg-dark-card border-gray-800 overflow-hidden">
            <div className="p-6 pb-2">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">Recent Matches</h2>                <Button asChild variant="ghost" size="sm" className="text-sm text-gray-400">
                  <Link to="/matches">
                    View All
                    <ChevronRight className="ml-1 h-4 w-4" />
                  </Link>
              ...
              <div className="text-center py-8">
                ...
                </p>                <Button asChild className="mt-4 bg-primary hover:bg-primary/90">
                  <Link to="/tournaments">
                    Browse Tournaments
                  </Link>
                </Button>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-dark-card border-gray-800 p-6">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-semibold mt-4">{userProfile.displayName || 'User'}</h2>
              
              <div className="flex gap-2 mt-2">
                <Badge variant="outline" className="border-primary text-primary">
                  {userProfile.gameId || 'BGMI'}
                </Badge>
              </div>
              ...
              {userProfile.gameId && (
                <div className="mt-3 px-3 py-1 bg-dark-lighter rounded-full text-sm flex items-center">
                  ...
                  <span className="font-mono">{userProfile.gameId}</span>
                </div>
              )}
              
              <div className="grid grid-cols-2 gap-4 w-full mt-6">                <Button asChild variant="outline" className="border-gray-700">
                  <Link to="/profile">
                    Edit Profile
                  </Link>
                </Button>
          ...
          {/* Upcoming Matches */}
          <div>
            <h3 style={{color: 'red', fontSize: '20px'}}>UPCOMING MATCHES COMPONENT:</h3>
            <UpcomingMatches />
          </div>
